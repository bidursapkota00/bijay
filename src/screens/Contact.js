        ...
        <div className="contact-wrap">
            ...
            <div className="contact-container">
                ...
                <div className="contact-sect">
                    <ContactItem icon={contact} text1={'+977 9857876543'} text2={'+977 9843463926'} title={'Phone'}/>
                    <ContactItem icon={emailme} text1={'bads1589@gmail.com'} text2={'bijayadsp1057@hotmail.com'} title={'Email'}/>
